...
```{r ppc-model1-study1, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 1"}
...
```{r outliers-model1-study1, cache=TRUE}
loo(model1)
```
...
```{r ppc-model2-study1, cache=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 2"}
...
```{r outliers-model2-study1, cache=TRUE}
...
```{r ppc-model3-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 3"}
...
```{r outliers-model3-study1, cache=TRUE}
...
```{r ppc-model4-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 4"}
model_diagnostics(model4)
```

Next, we check for potentially influential cases.
There are none.
```{r outliers-model4-study1}
loo(model4)
```
...
```{r ppc-model5-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 5"}
model_diagnostics(model5)
```

There are no cases flagged as potentially influential outliers.
```{r outliers-model5-study1, cache=TRUE}
...
```{r ppc-model6-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 6"}
...
```{r outliers-model6-study1, cache=TRUE}
...
```{r ppc-model7-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 7"}
model_diagnostics(model7)
```

One case is flagged as potentially influential, but unproblematic when calculated directly.
```{r outliers-model7-study1, cache=TRUE}
...
```{r ppc-model8-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 8"}
model_diagnostics(model8)
```

One case is flagged as potentially influential, but unproblematic after being calculated directly..
```{r outliers-model8-study1, cache=TRUE}
...
```{r ppc-model9-study1, echo=FALSE, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Posterior predictive checks for Model 9"}
model_diagnostics(model9)
```

Six cases are flagged as potentially influential, which is why we calculate ELPD directly.
```{r outliers-model9-study1, cache=TRUE}
...
model10 <- 
  brm(
    ...
    seed = 42,
    control = list(adapt_delta = 0.99),
    file = here("models", "study1", "model10.rds")
  )
```

Overall, the traceplots look fine and the chains seem to have mixed well, see (Figure \@ref(fig:inspect-model10)).
```{r inspect-model9, echo=FALSE, fig.cap="Traceplots and posterior distributions for Model 10"}
# load model
model10 <- read_rds(here("models", "study1", "model10.rds"))
