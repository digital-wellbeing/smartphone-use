...
```{r visualize-weekly-notifications-study1, ech=FALSE, fig.cap="Weekly notifications (objective) across all apps"}
single_cloud(
  study1,
  notifications,
  "weekly_notifications",
...
```{r visualize-correlations-traits-study1, fig.cap="Correlation matrix", fig.dim=c(12,12), echo=FALSE, message=FALSE}
ggpairs(
  data = study1 %>%
    group_by(id) %>% 
    slice(1) %>% 
...
```{r visualize-correlations-objective-subjective, message=FALSE, warning=F, echo=FALSE, fig.cap="Correlation matrix 2", fig.dim=c(12,12)}
ggpairs(
  data = study1 %>%
    select(
...
```{r visualize-correlations-objective-trait, message=FALSE, warning=F, echo=FALSE, fig.cap="Correlation matrix 3", fig.dim=c(15,15)}
ggpairs(
  data = study1 %>%
    select(
      social_media_subjective:weekly_notifications,
